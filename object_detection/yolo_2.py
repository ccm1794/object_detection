...
class ObjectDetection(Node):
    def __init__(self, img_size: Union[Tuple[int, int], None] = (640, 640)
        ...
        # Publishers for detect_length
        # self.detection_length_publisher = self.create_publisher

        # Realsense package
        self.bridge = CvBridge()
        
        # Subscribers
        self.sub_img = self.create_subscription(Image, 'video1', self.YOLOv7_detect, 10)
